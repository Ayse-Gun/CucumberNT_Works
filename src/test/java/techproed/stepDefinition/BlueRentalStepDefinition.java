...
public class BlueRentalStepDefinition {
    ...
    @And("kullanici tabloda verilen bilgilerle login olur")
    public void kullaniciTablodaVerilenBilgilerleLoginOlur(DataTable data) {
    ...
    public void kullaniciMapIleLoginOlur(DataTable data) {
