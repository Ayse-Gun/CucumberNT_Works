...
public class Hooks {
    ...
    /**
     Scenario'dan once calismasini istedigimiz
     @Before method'unun notasyonuna parametre olarak scenario'ya tanimladigimiz
    ...
    /**
     Bu method scenariolarda fail olan kismin resmini ekleyecektir
     Arac1 yerine arac2 yazip kasitli hata alicaz
     */
}
